...
from zooniverse.utils.data_format import data_prep, data_prep_all, data_prep_all_panoptics
...
class DataPrepTestCase(unittest.TestCase):
    ...
    def test_merge_point(self):
        """
        TODO 1. run the panoptics extractor
        TODO 2. merge the dataframes
        TODO 3. join image names
        :return:
        """
        ...
        ds_stats = data_prep_all_panoptics(phase_tag, input_path=input_path, output_path=output_path, config=config)
